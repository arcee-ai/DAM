...
@add_start_docstrings(
    ...
    [`MergedMistralForSequenceClassification`] uses the last token in order to do the classification, as other causal models
    (e.g. GPT-2) do.
...
class MergedMistralForSequenceClassification(MergedMistralPreTrainedModel):
    def __init__(self, config):
        super().__init__(config)
...
class MergedMistralForTokenClassification(MergedMistralPreTrainedModel):
    def __init__(self, config):
        super().__init__(config)
        self.num_labels = config.num_labels
        self.model = MergedMistralModel(config)
