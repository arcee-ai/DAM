...
_CONFIG_FOR_DOC = "MergedLlamaConfig"
...
class MergedLlamaRotaryEmbedding(nn.Module):
    def __init__(
        ...
        scaling_factor=1.0,
        rope_type="default",
        config: Optional[MergedLlamaConfig] = None,
    ):
        super().__init__()
...
class MergedLlamaLinearScalingRotaryEmbedding(MergedLlamaRotaryEmbedding):
...
class MergedLlamaDynamicNTKScalingRotaryEmbedding(MergedLlamaRotaryEmbedding):
...
class MergedLlamaAttention(nn.Module):
    """Multi-headed attention from 'Attention Is All You Need' paper"""

    def __init__(self, config: MergedLlamaConfig, layer_idx: Optional[int] = None):
        super().__init__()
        self.config = config
...
class MergedLlamaFlashAttention2(MergedLlamaAttention):
    """
...
class MergedLlamaSdpaAttention(MergedLlamaAttention):
    """
...
LLAMA_ATTENTION_CLASSES = {
    "eager": MergedLlamaAttention,
    "flash_attention_2": MergedLlamaFlashAttention2,
    "sdpa": MergedLlamaSdpaAttention,
}


class MergedLlamaDecoderLayer(nn.Module):
    def __init__(self, config: MergedLlamaConfig, layer_idx: int):
        super().__init__()
        self.hidden_size = config.hidden_size
...
class MergedLlamaPreTrainedModel(PreTrainedModel):
...
class MergedLlamaModel(MergedLlamaPreTrainedModel):
    """
...
class MergedLlamaForCausalLM(MergedLlamaPreTrainedModel):
...
class MergedLlamaForSequenceClassification(MergedLlamaPreTrainedModel):
    def __init__(self, config):
        super().__init__(config)
...
class MergedLlamaForQuestionAnswering(MergedLlamaPreTrainedModel):
...
class MergedLlamaForTokenClassification(MergedLlamaPreTrainedModel):
    def __init__(self, config):
        super().__init__(config)
        self.num_labels = config.num_labels
        self.model = MergedLlamaModel(config)
