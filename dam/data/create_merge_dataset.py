...
@click.option("--dataset_names", type=str, multiple=True, default=[
    "p1atdev/ichikara-instruction:20231115-1",
    "microsoft/orca-math-word-problems-200k",
    "meta-math/MetaMathQA"
], help="List of dataset names to load.")
@click.option("--model_ids", type=str, multiple=True, default=[
    "augmxnt/shisa-gamma-7b-v1",
    "WizardLM/WizardMath-7B-V1.1",
    "arcee-train/Abel-7B-002-truncated-embeds"
], help="List of model IDs to load.")
...
def main(k, dataset_names, model_ids, base_model_name, cache_dir, compute_logits, dataset_id):
    ...
    combined_dataset_with_top_k_logits = compute_and_save_topk_logits(models_dict, combined_dataset, device, batch_size=4, top_k=k, compute_logits=compute_logits)
