...
@click.option("--lambda_coef_l2", default=1e-6, help="L2 regularization coefficient.")
@click.option("--lambda_coef_entropy", default=0.1, help="Lambda coefficient for entropy loss.")
@click.option("--lambda_coef_mse", default=1.0, help="Lambda coefficient for mse loss.")
@click.option("--lambda_coef_overlap", default=1e-5, help="Lambda coefficient for overlap loss.")
